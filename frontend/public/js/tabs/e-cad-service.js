...
$(function () { /* brother, we have a problem, olha a visao geral, configurei a passagem de clientes
	porem tem uma diferencinha nos horários, pq n são os mesmos, ai desconfigura
	
	olha a responsividade tbm*/
	var categorias = [];
