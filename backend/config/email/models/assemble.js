                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        ...
                                                        <p style="font-size: 14px; line-height: 24px; margin: 0;"><span
                                                                style="font-size: 20px;">` + data.title +`</span></p>
                                                    </div>
                                                </div>
                                                <div
                                                    ...
                                                    <p
                                                        ...
                                                        <span style="font-size: 14px;">`+ data.text1+`</span></p>
                                                </div>
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <p
                                                        ...
                                                        <strong><span style="font-size: 14px; line-height: 16px;">`+ data.title2 +`</span></strong></p>
                                                </div>
                                                <div
                                                    ...
                                                    <p
                                                        ...
                                                        <span style="font-size: 14px;">`+data.text2+`</span></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                        ...
                                                        style="text-decoration:none;display:inline-block;color:#132F40;background-color:#FFD500;border-radius:50px;-webkit-border-radius:50px;-moz-border-radius:50px;width:auto; width:auto;;border-top:1px solid #FFD500;border-right:1px solid #FFD500;border-bottom:1px solid #FFD500;border-left:1px solid #FFD500;padding-top:5px;padding-bottom:5px;font-family:'Roboto', Tahoma, Verdana, Segoe, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;"><span
                                                            ...
                                                            <span style="font-size: 16px; line-height: 32px;"><span
                                                                    style="font-size: 15px; line-height: 30px;"><strong><span
                                                                            style="line-height: 30px; font-size: 15px;">`+data.button+`&gt;</span></strong></span></span>
                                                        </span></div>
                                            </div></a>
                                        </div></a>
                                    </div></a>
