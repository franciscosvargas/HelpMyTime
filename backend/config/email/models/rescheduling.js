                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        ...
                                                        <p style="font-size: 14px; line-height: 24px; margin: 0;"><span
                                                                style="font-size: 20px;">Olá ${data.usuario}, você vai precisar reagendar...</span></p>
                                                    </div>
                                                </div>
                                                <div style="display: flex; margin: 20px;">
                                                    ...
                                                    <div
                                                        ...
                                                        <p
                                                            ...
                                                            <span style="font-size: 14px;">O seu agendamento em ${data.estabelecimento}, às ${data.horario}h para o serviço <strong>${data.servico}</strong>
                                                                precisou ser desmarcado pelo estabelecimento. O estabelecimento pede que seja feito um novo agendamento em outro horário disponível.
                                                            </strong></span></p>
                                                    </div>
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <p
                                                        ...
                                                        Para <strong>REAGENDAR O SERVIÇO</strong></p>
                                                    <p
                                                        style="font-size: 12px; line-height: 14px; color: #555555; font-family: 'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif; margin: 0;">
                                                        agora, clique no botão abaixo.</p>
                                                </div>
                                                <div align="left" class="button-container"
                                                    style="padding-top:5px;padding-right:10px;padding-bottom:35px;padding-left:10px;">
                                                    <form id="form-id" action="http://" method="POST">
                                                        <input type="hidden" name="email" value="" />
                                                        <button
                                                            style="text-decoration:none;display:inline-block;color:#132F40;background-color:#FFD500;border-radius:50px;-webkit-border-radius:50px;-moz-border-radius:50px;width:auto; width:auto;;border-top:1px solid #FFD500;border-right:1px solid #FFD500;border-bottom:1px solid #FFD500;border-left:1px solid #FFD500;padding-top:5px;padding-bottom:5px;font-family:'Roboto', Tahoma, Verdana, Segoe, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;"><span
                                                                ...
                                                                <span style="font-size: 16px; line-height: 32px;"><span
                                                                        style="font-size: 15px; line-height: 30px;"><strong><span
                                                                                style="line-height: 30px; font-size: 15px;">REAGENDAR SERVIÇO &gt;</span></strong></span></span>
                                                            </span>
                                                </div>
                                                </button>
                                            </div></a>
